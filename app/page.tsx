...
export const metadata: Metadata = {
  ...
  description: 'اكتشف خدمات برينتكس للطباعة عالية الجودة، من البروشورات والكروت الشخصية إلى اللوحات الإعلانية الضخمة. دقة في التنفيذ وسرعة في التسليم.',
  
  // الكلمات المفتاحية (اختياري، لكنها تساعد في تنظيم الفئات)
  keywords: ['طباعة', 'printing', 'برينتكس', 'Printex', 'دعاية وإعلان', 'Advertising', 'خدمات طباعة', 'Printing Services', 'طباعة رقمية', 'Digital Printing', 'لوحات إعلانية', 'Billboards', 'كروت شخصية', 'Business Cards', 'بروشورات', 'Brochures'],
