...
const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`;
  return (
    <>
  <div className="flex-col justify-between gap-2  fixed bottom-6 end-6 z-[999]">
      <Link
      href={whatsappUrl}
       target="_blank"
    ...
    >
      ...
      href="https://www.facebook.com/Printexegy"
       target="_blank"
      rel="noopener noreferrer"
      className="flex items-center justify-center my-2 w-14 h-14 bg-blue-900 text-white rounded-full shadow-lg hover:scale-110 hover:bg-blue-700 transition-all duration-300 group"
